...
Comment::Comment(int _content_id, int _user_id, std::string _text): id(next_id++), user_id(_user_id), content_id(_content_id), text(_text) {}

Comment::Comment(int id, int _content_id, int _user_id, std::string _text): id(id), user_id(_user_id), content_id(_content_id), text(_text) 
{
